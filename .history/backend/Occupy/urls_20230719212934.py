...
from .views import  CliqueView,CliqueList,CliqueSearch,CliqueViewSet,PostListCreateView,PostRetrieveUpdateDeleteView,CliqueListCreateView,CliqueRetrieveUpdateDeleteView,CliqueViewSet
...
urlpatterns = [
  ...
  path('clique-view', views.CliqueViewSet.as_view(), name='clique_view')
]
