...
from .serializers import PostSerializer,CliqueSerializer,PostSerializer_detailed,CurrentCliqueSerializer
...
@api_view(http_method_names=['GET'])
def get_posts_for_clique(self,request:Request,*args,**kwargs):
    user = request.user
    serializer = CurrentCliqueSerializer(request,instance=Occupier)
