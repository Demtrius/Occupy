...
from .serializers import PostSerializer,CliqueSerializer,PostSerializer_detailed
...
class ListHomePosts(generics.ListAPIView):
    ...
    def get_queryset(self):
        return Post.objects.filter(clique_members_username = self.kwargs['username']).order_by('posted')
