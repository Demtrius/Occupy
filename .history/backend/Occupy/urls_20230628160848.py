...
from .views import  PostView,CliqueView,CliqueList,CliqueSearch,CliqueViewSet,PostListCreateView,PostRetrieveUpdateDeleteView
...
urlpatterns = [
  ...
  path(
      "<int:post_id>/", views.PostRetrieveUpdateDeleteView.as_view(),
      name='post_detail'
      )
