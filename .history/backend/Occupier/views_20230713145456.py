...
from .utils import generate_access_token,create_jwt_pair_for_occupier
...
class OccupierLoginView(APIView):
    ...
    def post(self, request):
        ...
        if occupier:
            ...
            tokens = create_jwt_pair_for_occupier(occupier)
            response = {"messsage":"Login Successfull", "tokens":tokens}
