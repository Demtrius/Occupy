...
from .serializers import RegisterSerializer,LoginSerializer,OccupierSerializer
from .models import Occupier
from django.contrib.auth import authenticate
from rest_framework.generics import GenericAPIView
from rest_framework import status,response,serializers,generics,viewsets
...
class OccupierList(generics.ListCreateAPIView):
