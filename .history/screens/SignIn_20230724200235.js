 ...
 fetch(`http://127.0.0.1:8000/auth/login/`,{
    ...
    return (
      <View style={styles.container}>
        ...
        <TextInput value={username} onChangeText={text => setUsername(text)} placeholder="Email" style={styles.labelContainer} autoCompleteType="username" textContentType='username'/>
