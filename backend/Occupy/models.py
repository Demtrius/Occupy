...
class Service(models.Model):
    provider = models.ForeignKey(Occupier,on_delete=models.CASCADE, related_name="services")
...
class Availability(models.Model):
    provider = models.ForeignKey(Occupier, on_delete=models.CASCADE, related_name="availability")
...
class Booking(models.Model):
    ...
    client = models.ForeignKey(Occupier, on_delete=models.CASCADE, related_name="bookings")
    date = models.DateField()
    start_time = models.TimeField()
    end_time = models.TimeField()
