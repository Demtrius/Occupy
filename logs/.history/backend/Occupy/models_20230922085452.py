...
class Comment(models.Model):
    ...
    occupier = models.ForeignKey(Occupier, related_name="comments_authored",on_delete=models.CASCADE,null=True)
    ...
    class Meta:
        ordering = ['created_on']
    # def __str__(self):
    #     return 'Comment {} by {}'.format(self.body,self.occupier.username)
    def __str__(self):
